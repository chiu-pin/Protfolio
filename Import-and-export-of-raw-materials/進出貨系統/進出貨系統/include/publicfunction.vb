...
Module publicfunction
    ...
    Public Sub LoginUser(ByVal userid As Object, ByVal pass As Object)
        Try
            ...
            With cmd
                .Connection = con
                .CommandText = "SELECT * FROM tblUser WHERE U_UNAME ='" & userid.Text & "' AND U_PASS = '" & pass.Text & "' where 檢查碼=1"
            End With
            ...
            If dt.Rows.Count > 0 Then
                ...
                ElseIf dt.Rows(0).Item("U_TYPE") = "員工" Then
                    With Form1
                        ...
                        .進貨ToolStripMenuItem.Visible = False
                        .出貨ToolStripMenuItem.Visible = False
                        .管理ToolStripMenuItem.Visible = False
                    End With
                    ShowForm(LoginForm1, Form1)
                    LoginForm1.Hide()
